            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_service">
                         <div class="service_thumb service_icon_bg_1 d-flex align-items-center justify-content-center">
                             <div class="service_icon">
                                 <img src="${pageContext.request.contextPath}/resources/img/service/service_icon_3.png" alt="">
                             </div>
                         </div>
                         <div class="service_content text-center">
                            <h3>Pet Spa</h3>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single_team">
                        <div class="thumb">
                            <img src="${pageContext.request.contextPath}/resources/img/team/1.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_team">
                        <div class="thumb">
                            <img src="${pageContext.request.contextPath}/resources/img/team/2.png" alt="">
                        </div>
                        <div class="member_name text-center">
                            <div class="mamber_inner">
                                <h4>jhon Smith</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_team">
                        <div class="thumb">
                            <img src="${pageContext.request.contextPath}/resources/img/team/3.png" alt="">
                        </div>
                        <div class="member_name text-center">
                            <div class="mamber_inner">
                                <h4>Rala Emaia</h4>
                ...
                <div class="col-lg-8">
                    <div class="contact_text text-center">
                        ...
                        <div class="contact_btn d-flex align-items-center justify-content-center">
                            <a href="${pageContext.request.contextPath}/resources/contact.html" class="boxed-btn4">Contact Us</a>
                            <p>Or  <a href="${pageContext.request.contextPath}/resources/#"> +880 4664 216</a></p>
                        </div>
                    </div>
                </div>
            </div>
