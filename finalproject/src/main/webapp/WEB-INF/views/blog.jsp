                ...
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="blog_left_sidebar">
                        ...
                        <nav class="blog-pagination justify-content-center d-flex">
                            <ul class="pagination">
                                <li class="page-item">
                                    <a href="${pageContext.request.contextPath}/resources/#" class="page-link" aria-label="Previous">
                                        <i class="ti-angle-left"></i>
                                    </a>
                                </li>
                                <li class="page-item">
                                    <a href="${pageContext.request.contextPath}/resources/#" class="page-link">1</a>
                                </li>
                                <li class="page-item active">
                                    <a href="${pageContext.request.contextPath}/resources/#" class="page-link">2</a>
                                </li>
                                <li class="page-item">
                                    <a href="${pageContext.request.contextPath}/resources/#" class="page-link" aria-label="Next">
