...
<h1 style="padding-bottom:40px;
	border-bottom:1px solid #000;">무료분양글 목록 페이지</h1>
...
<a href="${pageContext.request.contextPath}/partners/petinsert">등록페이지이동</a><br>
<a href="${pageContext.request.contextPath}/partners/mypage">파트너스페이지이동</a>
<!-- footer_start  -->
	<footer class="footer">
