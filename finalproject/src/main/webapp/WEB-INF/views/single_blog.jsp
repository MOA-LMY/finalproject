               ...
               <div class="navigation-top">
                  <div class="d-sm-flex justify-content-between text-center">
                     ...
                     <ul class="social-icons">
                        <li><a href="${pageContext.request.contextPath}/resources/#"><i class="fa fa-facebook-f"></i></a></li>
                        <li><a href="${pageContext.request.contextPath}/resources/#"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="${pageContext.request.contextPath}/resources/#"><i class="fa fa-dribbble"></i></a></li>
                        <li><a href="${pageContext.request.contextPath}/resources/#"><i class="fa fa-behance"></i></a></li>
                     </ul>
                  </div>
                           ...
                           <div class="desc">
                              ...
                              <div class="d-flex justify-content-between">
                                 <div class="d-flex align-items-center">
                                    <h5>
                                       <a href="${pageContext.request.contextPath}/resources/#">Emilly Blunt</a>
                                    </h5>
                                    <p class="date">December 4, 2017 at 3:12 pm </p>
                                 </div>
                                 <div class="reply-btn">
                                    <a href="${pageContext.request.contextPath}/resources/#" class="btn-reply text-uppercase">reply</a>
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class="col-lg-4">
               <div class="blog_right_sidebar">
                  ...
                  <aside class="single_sidebar_widget tag_cloud_widget">
                     ...
                     <ul class="list">
                        <li>
                           <a href="${pageContext.request.contextPath}/resources/#">project</a>
                        </li>
                        <li>
                           <a href="${pageContext.request.contextPath}/resources/#">love</a>
                        </li>
                        <li>
                  ...
                  <aside class="single_sidebar_widget instagram_feeds">
                     ...
                     <ul class="instagram_row flex-wrap">
                        <li>
                           <a href="${pageContext.request.contextPath}/resources/#">
                              <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/post/post_5.png" alt="">
                           </a>
                        </li>
                        <li>
                           <a href="${pageContext.request.contextPath}/resources/#">
