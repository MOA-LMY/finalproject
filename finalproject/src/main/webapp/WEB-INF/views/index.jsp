					...
					<div class="row">
						<div class="col-lg-6 col-md-8">
							<div class="short_contact_list">
								<ul>
									<li><a
										href="${pageContext.request.contextPath}/goodtest">원태 테ss스트용 지우지마세요</a></li>
									<li><a
    ...
    <div class="slider_area">
        <div class="single_slider slider_bg_1 d-flex align-items-center">
            ...
            <div class="dog_thumb d-none d-lg-block">
                <img src="${pageContext.request.contextPath}/resources/img/banner/dog.png" alt="">
            </div>
        </div>
    </div>
    <!-- slider_area_end -->
            ...
            <!-- 슬라이드 구현 부부 ㄴ -->
                    ...
                    <div class="single_service">
                         <div class="service_thumb service_icon_bg_1 d-flex align-items-center justify-content-center">
                             <div class="service_icon">
                                 <img src="${pageContext.request.contextPath}/resources/img/doggum/doggum1.jpg" alt="" >
                             </div>
                         </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_service active">
                         <div class="service_thumb service_icon_bg_1 d-flex align-items-center justify-content-center">
                             <div class="service_icon">
                                 <img src="${pageContext.request.contextPath}/resources/img/doggum/doggum3.jpg" alt="">
                             </div>
                         </div>
                         <div class="service_content text-center">
                            <h3>B 개껌 </h3>
    ...
    <div class="pet_care_area">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="pet_thumb">
                        <img src="${pageContext.request.contextPath}/resources/img/about/pet_care.png" alt="">
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <div class="single_adapt text-center">
                                    <img src="${pageContext.request.contextPath}/resources/img/adapt_icon/1.png" alt="">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single_adapt text-center">
                                    <img src="${pageContext.request.contextPath}/resources/img/adapt_icon/3.png" alt="">
                                    <div class="adapt_content">
                                ...
                                <div class="single_adapt text-center">
                                    <img src="${pageContext.request.contextPath}/resources/img/adapt_icon/2.png" alt="">
                                    <div class="adapt_content">
                                        <h3><span class="counter">52</span>+</h3>
                                        <p>Pets Available</p>
                                    </div>
