...
/* color sql*/
insert  into color values(color_seq.nextval,1,'화이트','#FFFEF9');
insert  into color values(color_seq.nextval,2,'베이지','#DEB887');
insert  into color values(color_seq.nextval,3,'옐로우','#FCF16E');
